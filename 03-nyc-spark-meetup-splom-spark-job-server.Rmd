...
subtitle: "Unlocking The Power Of Big Data"
output:
...
```
-->
<img style="padding-top:60px;width:100%" src="images/3/modeling.png" />

## The Dream - Prediction
A model that:

1. Consumes raw market/indictive data
2. **Automatically** produces **actionable information** that **business users** can leverage to make decisions
...
<div class="columns-2">
  ...
  <h2 style="color:white">Externally</h2>
  <br><br>
  HTML5 Application
  <br><br>
  Spark Job Server
