...
## What's The Dream? - Understanding The Past {.centered}
```{r, echo=FALSE}
DiagrammeR::mermaid("
graph TB
A[Raw Data]-->B[Data On Cluster]
B[Data On Cluster]-->C[On Cluster]
", width = "800", height = "500")
```
...
DiagrammeR::mermaid("
graph TB
A[Extract Features On Cluster]-->B[Understand Features]
B[Data On Cluster]-->A[On Cluster]
", width = "800", height = "500")
```

## What's The Dream? - Predicting The Future {.centered}
...
<img src="images/3/davinci.jpg" width="100%" />
