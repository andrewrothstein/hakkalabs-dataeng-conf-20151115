...
## Word Count So Easy! {.smalldoubleplus}
...
<footer class="source">Source: http://www.dispuutcirce.nl/leden/img_2426/
...
> - Multiple main classes
    - Exploratory Analysis, Model Training, Model Evaluation and etc
> - Multiple projects
    - Core, Batch ETL, ML, Streaming, Visualization and etc
> - Multiple configurations
    - Different Datasets, Parameters and etc
> - Multiple deployment locations
    - local, yarn, EC2 and etc
...
<footer class="source">Source: http://www.blankchapters.com/2012/12/22/big-data-is-not-always-the-solution-to-all-our-problems</footer>
